...
public class FXApplication extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
		SplashPreloader splashPreloader=new SplashPreloader();
		splashPreloader.start();
		Thread t=new Thread( ()->{
			...
			splashPreloader.notify("Loading Json Files");
			...
			Platform.runLater(()->{
				...
				try{FXApplication.primaryScene = new Scene(uiLoader.load(), visualBounds.getWidth()/1.2, visualBounds.getHeight()/1.2, false, SceneAntialiasing.BALANCED);}catch(Exception e){e.printStackTrace();}
