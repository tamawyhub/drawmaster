...
public class FXHelper {
    ...
    public static void exportToMachine(String portName, boolean seperatePens){
		...
		Platform.runLater(() -> {
			try {
				...
				DrawingBotV3.INSTANCE.createExportTask(DrawingBotV3.INSTANCE.getActiveTask(), IGeometry.DEFAULT_FILTER, portName, seperatePens, false);
			}
